            ...
            <div className="container">
                ...
                <div className="row mt-5">
                    <div className="col-md-4">
                        ...
                        >
                            <div className="card-body">
                                <h5 className="card-title">GI Round Bar</h5>
                    ...
                    <div className="col-md-4">
                        ...
                        >
                            <div className="card-body">
                                <h5 className="card-title">GI Square bar</h5>
                                <p className="card-text">
                                    Lorem ipsum dolor sit amet consectetur, adipisicing elit.
                    ...
                    <div className="col-md-4">
                        ...
                        >
                            <div className="card-body">
                                <h5 className="card-title">GI Flat Bar</h5>
                                <p className="card-text">
            ...
            >
                <div className="modal-dialog modal-lg">
                    <div className="modal-content">
                        ...
                        <div className="modal-body">GI Round Bar</div>
                    </div>
                </div>
            </div>
            ...
            >
                <div className="modal-dialog modal-lg">
                    <div className="modal-content">
                        ...
                        <div className="modal-body">GI Square Bar</div>
                    </div>
                </div>
            </div>
            ...
            >
                <div className="modal-dialog modal-lg">
                    <div className="modal-content">
                        ...
                        <div className="modal-body">GI Flat Bar</div>
                    </div>
                </div>
            </div>
        </>
...
export default GIRoundSquareFlat;