            ...
            <div className="container">
                ...
                <div className="row mt-5">
                    <div className="col-md-4">
                        ...
                        >
                            <div className="card-body">
                                <h5 className="card-title">SS Angle</h5>
                    ...
                    <div className="col-md-4">
                        ...
                        >
                            <div className="card-body">
                                <h5 className="card-title">SS Channel</h5>
                                <p className="card-text">
                                    Lorem ipsum dolor sit amet consectetur, adipisicing elit.
                    ...
                    <div className="col-md-4">
                        ...
                        >
                            <div className="card-body">
                                <h5 className="card-title">SS Beam</h5>
                                <p className="card-text">
            ...
            >
                <div className="modal-dialog modal-lg">
                    <div className="modal-content">
                        ...
                        <div className="modal-body">SS Angle</div>
                    </div>
                </div>
            </div>
            ...
            >
                <div className="modal-dialog modal-lg">
                    <div className="modal-content">
                        ...
                        <div className="modal-body">SS Channel</div>
                    </div>
                </div>
            </div>
            ...
            >
                <div className="modal-dialog modal-lg">
                    <div className="modal-content">
                        ...
                        <div className="modal-body">SS Beam</div>
                    </div>
                </div>
            </div>
        </>
